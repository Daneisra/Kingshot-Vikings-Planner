...
const envSchema = z.object({
  ...
  ADMIN_SECONDARY_PASSWORD: z.string().min(8, "ADMIN_SECONDARY_PASSWORD must be at least 8 characters").optional(),
...
export const config = {
  ...
  adminSecondaryPassword: parsedEnv.ADMIN_SECONDARY_PASSWORD,
